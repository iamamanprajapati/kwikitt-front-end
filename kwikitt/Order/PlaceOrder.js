...
import AsyncStorage from '@react-native-community/async-storage';
 ...
 class PlaceOrder extends Component {
    ...
    render() {
        ...
        return(
           <View style={{flex:1,alignItems:'center',backgroundColor:'#a6b8a6'}}>
               <View style={{flex:.5,backgroundColor:'white',width:230,justifyContent:'center',marginTop:100,elevation:6}}>
