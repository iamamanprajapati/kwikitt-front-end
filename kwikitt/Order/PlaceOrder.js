        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1, marginTop: 25 }}>
                    <Text style={{ color: 'red', fontSize: 13, marginLeft: 13, fontWeight: 'bold' }}>SELECTED ADDRESS</Text>
                    <ImageBackground style={{ marginLeft: 5, marginRight: 5, padding: 5, backgroundColor: 'white', borderWidth: 4, borderColor: 'white', elevation: 4, height: 150 }}>
                        <View style={{ flex: 1, flexDirection: 'row' }}>
                            ...
                            <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                                ...
                                />
                                <Text style={{ color: 'red', marginTop: 0, fontSize: 10 }}>Change</Text>
